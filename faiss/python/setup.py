...
if platform.system() != "AIX":
    assert (
        ...
        f"{swigfaiss_avx2_lib} or {swigfaiss_avx512_lib} or {swigfaiss_avx512_spr_lib} or {swigfaiss_amx_lib} or {swigfaiss_sve_lib} or {faiss_example_external_module_lib}. "
